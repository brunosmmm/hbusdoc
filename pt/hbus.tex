...
\newcommand{\hbus}[1]{\includegraphics[scale=#1]{hbus}}
\newcommand{\hbuscommand}[1]{\textbf{#1}}

\begin{center}
\topskip0pt
\vspace*{\fill}
\includegraphics[scale=3]{hbuslogo}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{hbus_house.ps}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{anem_mono_schem.ps}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{LEDCTL2CH}
