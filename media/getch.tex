% XCircuit output "getch.tex" for LaTeX input from getch.ps
...
\begin{center}
   ...
   \putbox{1.22in}{0.89in}{1.20}{\centbox{\midbox{0x01}}}%
   \putbox{1.81in}{1.39in}{1.20}{5}%
   \putbox{1.06in}{0.06in}{1.20}{Endereco}%
   \putbox{1.89in}{0.89in}{0.96}{\centbox{\midbox{ADDR}}}%
   } % close 'parbox'
   } % close 'scalebox'
